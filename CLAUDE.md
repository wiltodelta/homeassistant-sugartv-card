...
| File                            | Covers                                                                                                                                                                                                                     |
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.claude/rules/ha-entities.md`  | Entity-id resolution (names not keys, tail-matching), `setConfig`-before-`hass` ordering, `last_updated` vs `last_reported` freshness, the age ladder (median cadence, one-way fade, staleness), sections-view grid sizing |
