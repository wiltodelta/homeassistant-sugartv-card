export const languages = {
    en: {
        ...
        editor: {
            ...
            dim_by_age: 'Fade the card as the reading gets older',
    ...
    ru: {
        ...
        editor: {
            ...
            dim_by_age: 'Приглушать карточку по мере устаревания',
    ...
    de: {
        ...
        editor: {
            ...
            dim_by_age: 'Karte abblenden, wenn die Messung altert',
    ...
    fr: {
        ...
        editor: {
            ...
            dim_by_age: 'Estomper la carte à mesure que la mesure vieillit',
    ...
    es: {
        ...
        editor: {
            ...
            dim_by_age: 'Atenuar la tarjeta a medida que la medición envejece',
    ...
    it: {
        ...
        editor: {
            ...
            dim_by_age:
                'Attenuare la scheda man mano che la misurazione invecchia',
    ...
    nl: {
        ...
        editor: {
            ...
            dim_by_age: 'Kaart dimmen naarmate de meting ouder wordt',
    ...
    pl: {
        ...
        editor: {
            ...
            dim_by_age: 'Przygaszaj kartę w miarę starzenia się pomiaru',
    ...
    uk: {
        ...
        editor: {
            ...
            dim_by_age: 'Приглушувати картку в міру старіння вимірювання',
    ...
    pt: {
        ...
        editor: {
            ...
            dim_by_age: 'Atenuar o cartão à medida que a medição envelhece',
    ...
    sv: {
        ...
        editor: {
            ...
            dim_by_age: 'Tona ned kortet när mätningen blir äldre',
    ...
    cs: {
        ...
        editor: {
            ...
            dim_by_age: 'Ztlumit kartu, jak měření stárne',
    ...
    af: {
        ...
        editor: {
            ...
            dim_by_age: 'Verdof die kaart namate die lesing ouer word',
    ...
    ar: {
        ...
        editor: {
            ...
            dim_by_age: 'تعتيم البطاقة كلما تقادمت القراءة',
    ...
    bg: {
        ...
        editor: {
            ...
            dim_by_age: 'Затъмняване на картата с остаряване на измерването',
    ...
    bn: {
        ...
        editor: {
            ...
            dim_by_age: 'পরিমাপ পুরোনো হওয়ার সাথে কার্ড ম্লান করুন',
    ...
    bs: {
        ...
        editor: {
            ...
            dim_by_age: 'Prigušiti karticu kako mjerenje stari',
    ...
    ca: {
        ...
        editor: {
            ...
            dim_by_age: 'Atenuar la targeta a mesura que la mesura envelleix',
    ...
    cy: {
        ...
        editor: {
            ...
            dim_by_age: "Pylu'r cerdyn wrth i'r darlleniad heneiddio",
    ...
    da: {
        ...
        editor: {
            ...
            dim_by_age: 'Dæmp kortet, efterhånden som målingen bliver ældre',
    ...
    el: {
        ...
        editor: {
            ...
            dim_by_age: 'Εξασθένιση της κάρτας καθώς η μέτρηση παλιώνει',
    ...
    eo: {
        ...
        editor: {
            ...
            dim_by_age: 'Malheligi la karton dum la mezuro maljuniĝas',
    ...
    et: {
        ...
        editor: {
            ...
            dim_by_age: 'Tumenda kaart, kui mõõtmine vananeb',
    ...
    eu: {
        ...
        editor: {
            ...
            dim_by_age: 'Txartela ilundu neurketa zahartu ahala',
    ...
    fa: {
        ...
        editor: {
            ...
            dim_by_age: 'کم‌رنگ کردن کارت با قدیمی شدن اندازه‌گیری',
        ...
        editor: {
            ...
            dim_by_age: 'Himmennä kortti mittauksen vanhetessa',
    ...
    fy: {
        ...
        editor: {
            ...
            dim_by_age: 'Kaart dimme as de mjitting âlder wurdt',
    ...
    ga: {
        ...
        editor: {
            ...
            dim_by_age:
                'Lagaigh an cárta de réir mar a théann an léamh in aois',
    ...
    gl: {
        ...
        editor: {
            ...
            dim_by_age: 'Atenuar a tarxeta a medida que a medición envellece',
    ...
    gsw: {
        ...
        editor: {
            ...
            dim_by_age: 'Charte abdunkle, wenn d Mässig elter wird',
    ...
    he: {
        ...
        editor: {
            ...
            dim_by_age: 'עמעום הכרטיס ככל שהמדידה מתיישנת',
    ...
    hi: {
        ...
        editor: {
            ...
            dim_by_age: 'माप पुराना होने पर कार्ड को धुँधला करें',
    ...
    hr: {
        ...
        editor: {
            ...
            show_prediction: 'Prognoza glukoze',
            relative_time: 'Prikaži starost mjerenja umjesto sata',
            dim_by_age: 'Priguši karticu kako mjerenje stari',
            color_thresholds: 'Obojene zone glukoze',
            urgent_low: 'Kritično nisko',
            low: 'Nisko',
            high: 'Visoko',
    ...
    hu: {
        ...
        editor: {
            ...
            dim_by_age: 'A kártya halványítása a mérés öregedésével',
    ...
    hy: {
        ...
        editor: {
            ...
            dim_by_age: 'Մթագնել քարտը չափման հնանալուն զուգընթաց',
    ...
    id: {
        ...
        editor: {
            ...
            dim_by_age: 'Redupkan kartu seiring pembacaan menua',
    ...
    is: {
        ...
        editor: {
            ...
            dim_by_age: 'Deyfa kortið eftir því sem mælingin eldist',
    ...
    ja: {
        ...
        editor: {
            ...
            dim_by_age: '測定が古くなるにつれてカードを淡く表示',
    ...
    ka: {
        ...
        editor: {
            ...
            dim_by_age: 'ბარათის ჩაქრობა გაზომვის დაძველებასთან ერთად',
    ...
    ko: {
        ...
        editor: {
            ...
            dim_by_age: '측정이 오래될수록 카드를 흐리게 표시',
    ...
    lb: {
        ...
        editor: {
            ...
            dim_by_age: "Kaart ofdunkelen, wann d'Miessung eeler gëtt",
    ...
    lt: {
        ...
        editor: {
            ...
            dim_by_age: 'Pritemdyti kortelę matavimui senstant',
    ...
    lv: {
        ...
        editor: {
            ...
            dim_by_age: 'Aptumšot karti, mērījumam novecojot',
    ...
    mk: {
        ...
        editor: {
            ...
            dim_by_age: 'Затемни ја картичката како мерењето старее',
    ...
    ml: {
        ...
        editor: {
            ...
            dim_by_age: 'അളവ് പഴകുന്നതിനനുസരിച്ച് കാർഡ് മങ്ങിക്കുക',
    ...
    nb: {
        ...
        editor: {
            ...
            dim_by_age: 'Demp kortet etter hvert som målingen blir eldre',
    ...
    nn: {
        ...
        editor: {
            ...
            dim_by_age: 'Demp kortet etter kvart som målinga blir eldre',
    ...
    'pt-BR': {
        ...
        editor: {
            ...
            show_prediction: 'Previsão de glicose',
            relative_time: 'Mostrar há quanto tempo em vez da hora',
            dim_by_age: 'Atenuar o cartão conforme a medição envelhece',
            color_thresholds: 'Zonas de glicose coloridas',
            urgent_low: 'Muito baixo',
            low: 'Baixo',
            high: 'Alto',
    ...
    ro: {
        ...
        editor: {
            ...
            dim_by_age: 'Estompează cardul pe măsură ce măsurarea îmbătrânește',
    ...
    sk: {
        ...
        editor: {
            ...
            dim_by_age: 'Stlmiť kartu, ako meranie starne',
    ...
    sl: {
        ...
        editor: {
            ...
            dim_by_age: 'Zatemni kartico, ko se meritev stara',
    ...
    sq: {
        ...
        editor: {
            ...
            dim_by_age: 'Zbeh kartën ndërsa matja plaket',
    ...
    sr: {
        ...
        editor: {
            ...
            dim_by_age: 'Пригуши картицу како мерење стари',
    ...
    'sr-Latn': {
        ...
        editor: {
            ...
            dim_by_age: 'Priguši karticu kako merenje stari',
            color_thresholds: 'Obojene zone glukoze',
            urgent_low: 'Kritično nisko',
            low: 'Nisko',
            high: 'Visoko',
    ...
    ta: {
        ...
        editor: {
            ...
            dim_by_age: 'அளவீடு பழையதாகும்போது அட்டையை மங்கலாக்கு',
    ...
    te: {
        ...
        editor: {
            ...
            dim_by_age: 'కొలత పాతబడుతున్న కొద్దీ కార్డును మసకబరచు',
    ...
    th: {
        ...
        editor: {
            ...
            dim_by_age: 'หรี่การ์ดลงเมื่อค่าที่วัดเก่าลง',
    ...
    tr: {
        ...
        editor: {
            ...
            dim_by_age: 'Ölçüm eskidikçe kartı soluklaştır',
    ...
    ur: {
        ...
        editor: {
            ...
            dim_by_age: 'پیمائش پرانی ہونے پر کارڈ کو دھندلا کریں',
    ...
    vi: {
        ...
        editor: {
            ...
            dim_by_age: 'Làm mờ thẻ khi số đo cũ dần',
